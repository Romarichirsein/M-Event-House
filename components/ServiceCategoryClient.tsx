...
export default function ServiceCategoryClient({ slug, content }: ServiceCategoryClientProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-2xl text-[var(--text-secondary)] font-light leading-relaxed">
              {slug === 'traiteur' && "Une excellence gastronomique au service de vos émotions."}
              {slug === 'decoration' && "Sublimez chaque espace pour le transformer en un lieu magique."}
              {slug === 'surprise' && "Créez l'inattendu avec des mises en scène spectaculaires."}
            </p>
            <div className="pt-8">
